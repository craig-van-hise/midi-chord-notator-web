# WORK ORDER: `6-13-ui-coder`
**Status:** 🔘 Pending
**Description:** Rendering accidentals adjacent to noteheads.
...
* **Working Directory:** `WOs/grand-staff-app/Phase_6`
* **Files in Scope:** All relevant project files for Phase 6.
* **Current State:** Pending Phase 6 initiation.
* **The Goal:** Accidentals render at calc(X - 1.5 * space).
...
## 3. Task List
### Stage 1: Implement ui-coder Responsibilities
* **Objective:** Execute task.
* **Tasks:**
    1. Read PDD Phase 6 and implement according to rules.
